...
@section('content')
        ...
        <!-- highlights-section -->
        <section class="highlights-section home-5 alternat-2 pb_80">
            <div class="large-container">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-2 col-md-4 col-sm-12 brand-block">
                            <div class="brand-block-one">
                                <div class="inner-box">
                                    <a href="index.html">
                                        <figure class="image"><img src="frontend/assets/images/brands/brands-1.png" alt=""></figure>
                                        <span>Audi</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 brand-block">
                            <div class="brand-block-one">
                                <div class="inner-box">
                                    <a href="index.html">
                                        <figure class="image"><img src="frontend/assets/images/brands/brands-2.png" alt=""></figure>
                                        <span>BMW</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 brand-block">
                            <div class="brand-block-one">
                                <div class="inner-box">
                                    <a href="index.html">
                                        <figure class="image"><img src="frontend/assets/images/brands/brands-3.png" alt=""></figure>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 brand-block">
                            <div class="brand-block-one">
                                <div class="inner-box">
                                    <a href="index.html">
                                        <figure class="image"><img src="frontend/assets/images/brands/brands-4.png" alt=""></figure>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 brand-block">
                            <div class="brand-block-one">
                                <div class="inner-box">
                                    <a href="index.html">
                                        <figure class="image"><img src="frontend/assets/images/brands/brands-5.png" alt=""></figure>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 brand-block">
                            <div class="brand-block-one">
                                <div class="inner-box">
                                    <a href="index.html">
                                        <figure class="image"><img src="frontend/assets/images/brands/brands-6.png" alt=""></figure>
                                        <span>Porsche</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 brand-block">
                            <div class="brand-block-one">
                                <div class="inner-box">
                                    <a href="index.html">
                                        <figure class="image"><img src="frontend/assets/images/brands/brands-7.png" alt=""></figure>
                                        <span>Hyundai</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 brand-block">
                            <div class="brand-block-one">
                                <div class="inner-box">
                                    <a href="index.html">
                                        <figure class="image"><img src="frontend/assets/images/brands/brands-8.png" alt=""></figure>
                                        <span>Volvo</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 brand-block">
                            <div class="brand-block-one">
                                <div class="inner-box">
                                    <a href="index.html">
                                        <figure class="image"><img src="frontend/assets/images/brands/brands-9.png" alt=""></figure>
                                        <span>Skoda</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 brand-block">
                            <div class="brand-block-one">
                                <div class="inner-box">
                                    <a href="index.html">
                                        <figure class="image"><img src="frontend/assets/images/brands/brands-10.png" alt=""></figure>
                                        <span>Jaguar</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 brand-block">
                            <div class="brand-block-one">
                                <div class="inner-box">
                                    <a href="index.html">
                                        <figure class="image"><img src="frontend/assets/images/brands/brands-11.png" alt=""></figure>
                                        <span>Ford</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 brand-block">
                            <div class="brand-block-one">
                                <div class="inner-box">
                                    <a href="index.html">
                                        <figure class="image"><img src="frontend/assets/images/brands/brands-12.png" alt=""></figure>
                                        <span>Suzuki</span>
                                    </a>
                                </div>
                            </div>
       ...
       highlights-style-two end -->
                ...
                <div class="four-item-carousel owl-carousel owl-theme owl-dots-none nav-style-one">
                        ...
                        <div class="inner-box">
                            <div class="image-box">
                                ...
                                <ul class="option-list-two">
                                    <li><a href="frontend/assets/images/shop/shop-5.png" class="lightbox-image" data-fancybox="gallery"><i class="icon-12"></i></a></li>
                                    <li><a href="shop-details.html"><i class="icon-1"></i></a></li>
                                    <li><button type="button"><i class="icon-7"></i></button></li>
                                </ul>
                                <figure class="image"><img src="frontend/assets/images/shop/shop-5.png" alt=""></figure>
                            </div>
                    ...
                    <div class="shop-block-one">
                        <div class="inner-box">
                            <div class="image-box">
                                ...
                                <ul class="option-list-two">
                                    <li><a href="frontend/assets/images/shop/shop-2.png" class="lightbox-image" data-fancybox="gallery"><i class="icon-12"></i></a></li>
                                    <li><a href="shop-details.html"><i class="icon-1"></i></a></li>
                                    <li><button type="button"><i class="icon-7"></i></button></li>
                                </ul>
                                <figure class="image"><img src="frontend/assets/images/shop/shop-2.png" alt=""></figure>
                            </div>
                            <div class="lower-content">
                                <span class="text">Interior</span>
                                <h4><a href="shop-details.html">Toyota Starlet EP-82 HEAD Lights</a></h4>
                    ...
                    <div class="shop-block-one">
                        <div class="inner-box">
                            <div class="image-box">
                                <ul class="option-list-two">
                                    <li><a href="frontend/assets/images/shop/shop-23.png" class="lightbox-image" data-fancybox="gallery"><i class="icon-12"></i></a></li>
                                    <li><a href="shop-details.html"><i class="icon-1"></i></a></li>
                                    <li><button type="button"><i class="icon-7"></i></button></li>
                                </ul>
                                <figure class="image"><img src="frontend/assets/images/shop/shop-23.png" alt=""></figure>
                            </div>
                            <div class="lower-content">
                                <span class="text">Wheel</span>
                    ...
                    <div class="shop-block-one">
                        <div class="inner-box">
                            <div class="image-box">
                                <ul class="option-list-two">
                                    <li><a href="frontend/assets/images/shop/shop-24.png" class="lightbox-image" data-fancybox="gallery"><i class="icon-12"></i></a></li>
                                    <li><a href="shop-details.html"><i class="icon-1"></i></a></li>
                                    <li><button type="button"><i class="icon-7"></i></button></li>
                                </ul>
                                <figure class="image"><img src="frontend/assets/images/shop/shop-24.png" alt=""></figure>
                            </div>
                            <div class="lower-content">
                                <span class="text">Front</span>
                                <h4><a href="shop-details.html">14" Urban X Phantom Wheel Cover Set </a></h4>
                                <h5>$80.99</h5>
                                <ul class="rating"> 
                                    <li><i class="icon-41"></i></li>
                                    <li><i class="icon-41"></i></li>
        ...
        <section class="category-style-two pb_70">
            <div class="auto-container">
                <div class="sec-title mb_30">
                    ...
                    <a href="index-2.html">View All Categories</a>
                </div>
                <div class="row clearfix">
                    <div class="col-lg-5 col-md-12 col-sm-12 ads-column">
                        <div class="feature-block-one">
                            <div class="inner-box">
                                ...
                                <h2><a href="shop-details.html">Buy Engine Oil</a></h2>
                                <h4>From $83.99</h4>
                                <div class="btn-box"><a href="shop-details.html" class="theme-btn">Shop now <span></span><span></span><span></span><span></span></a></div>
                                <figure class="image"><img src="frontend/assets/images/resource/feature-4.png" alt=""></figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-4 col-md-6 col-sm-12 category-block">
                                    <div class="category-block-two">
                                        <div class="inner-box">
                                            <h4><a href="shop-details.html">Light & Optics</a></h4>
                                            <span class="text">20 Items</span>
                                            <figure class="image"><img src="frontend/assets/images/resource/category-7.png" alt=""></figure>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 category-block">
                                    <div class="category-block-two">
                                        <div class="inner-box">
                                            <h4><a href="shop-details.html">Braking System</a></h4>
                                            <span class="text">12 Items</span>
                                            <figure class="image"><img src="frontend/assets/images/resource/category-8.png" alt=""></figure>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 category-block">
                                    <div class="category-block-two">
                                        <div class="inner-box">
                                            <h4><a href="shop-details.html">Car Wheels</a></h4>
                                            <span class="text">30 Items</span>
                                            <figure class="image"><img src="frontend/assets/images/resource/category-9.png" alt=""></figure>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 category-block">
                                    <div class="category-block-two">
                                        <div class="inner-box">
                                            <h4><a href="shop-details.html">Exhaust System</a></h4>
                                            <span class="text">10 Items</span>
                                            <figure class="image"><img src="frontend/assets/images/resource/category-10.png" alt=""></figure>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 category-block">
                                    <div class="category-block-two">
                                        <div class="inner-box">
                                            <h4><a href="shop-details.html">Cooling System</a></h4>
                                            <span class="text">16 Items</span>
                                            <figure class="image"><img src="frontend/assets/images/resource/category-11.png" alt=""></figure>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 category-block">
                                    <div class="category-block-two">
                                        <div class="inner-box">
                                            <h4><a href="shop-details.html">Exterior Parts</a></h4>
                                            <span class="text">08 Items</span>
                                            <figure class="image"><img src="frontend/assets/images/resource/category-12.png" alt=""></figure>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="shop-style-two pt_110 pb_70">
            ...
            <div class="pattern-layer">
                <div class="pattern-1" style="background-image: url(frontend/assets/images/shape/shape-4.png);"></div>
                <div class="pattern-2" style="background-image: url(frontend/assets/images/shape/shape-5.png);"></div>
            </div>
            <div class="auto-container">
                                    ...
                                    <div class="inner-box">
                                        <div class="image-box">
                                            ...
                                            <ul class="option-list">
                                                <li><a href="frontend/assets/images/shop/shop-15.png" class="lightbox-image" data-fancybox="gallery"><i class="icon-12"></i></a></li>
                                                <li><a href="shop-details.html"><i class="icon-1"></i></a></li>
                                                <li><button type="button"><i class="icon-7"></i></button></li>
                                            </ul>
                                            <figure class="image"><img src="frontend/assets/images/shop/shop-15.png" alt=""></figure>
                                        </div>
                                        <div class="content-box">
                                            <h6><a href="shop-details.html">Super Bright Halogen Bulbs</a></h6>
                                            <ul class="rating"> 
                                                <li><i class="icon-41"></i></li>
                                                <li><i class="icon-41"></i></li>
                                                <li><i class="icon-41"></i></li>
                                ...
                                <div class="shop-block-two">
                                    <div class="inner-box">
                                        <div class="image-box">
                                            ...
                                            <ul class="option-list">
                                                <li><a href="frontend/assets/images/shop/shop-16.png" class="lightbox-image" data-fancybox="gallery"><i class="icon-12"></i></a></li>
                                                <li><a href="shop-details.html"><i class="icon-1"></i></a></li>
                                                <li><button type="button"><i class="icon-7"></i></button></li>
                                            </ul>
                                            <figure class="image"><img src="frontend/assets/images/shop/shop-16.png" alt=""></figure>
                                        </div>
                                        <div class="content-box">
                                            <h6><a href="shop-details.html">Super Bright Halogen Bulbs</a></h6>
                                            <ul class="rating"> 
                                ...
                                <div class="shop-block-two">
                                    <div class="inner-box">
                                        <div class="image-box">
                                            ...
                                            <ul class="option-list">
                                                <li><a href="frontend/assets/images/shop/shop-17.png" class="lightbox-image" data-fancybox="gallery"><i class="icon-12"></i></a></li>
                                                <li><a href="shop-details.html"><i class="icon-1"></i></a></li>
                                                <li><button type="button"><i class="icon-7"></i></button></li>
                                            </ul>
                                            <figure class="image"><img src="frontend/assets/images/shop/shop-17.png" alt=""></figure>
                                        </div>
                                        <div class="content-box">
                                            <h6><a href="shop-details.html">Super Bright Halogen Bulbs</a></h6>
                                            <ul class="rating"> 
                                ...
                                <div class="shop-block-two">
                                    <div class="inner-box">
                                        <div class="image-box">
                                            <span class="hot-product">Sale</span>
                                            <ul class="option-list">
                                                <li><a href="frontend/assets/images/shop/shop-18.png" class="lightbox-image" data-fancybox="gallery"><i class="icon-12"></i></a></li>
                                                <li><a href="shop-details.html"><i class="icon-1"></i></a></li>
                                                <li><button type="button"><i class="icon-7"></i></button></li>
                                            </ul>
                                            <figure class="image"><img src="frontend/assets/images/shop/shop-18.png" alt=""></figure>
                                        </div>
                                        <div class="content-box">
                                            <h6><a href="shop-details.html">Super Bright Halogen Bulbs</a></h6>
                                            <ul class="rating"> 
                                ...
                                <div class="shop-block-two">
                                    <div class="inner-box">
                                        <div class="image-box">
                                            <span class="popular-product">Popular</span>
                                            <ul class="option-list">
                                                <li><a href="frontend/assets/images/shop/shop-19.png" class="lightbox-image" data-fancybox="gallery"><i class="icon-12"></i></a></li>
                                                <li><a href="shop-details.html"><i class="icon-1"></i></a></li>
                                                <li><button type="button"><i class="icon-7"></i></button></li>
                                            </ul>
                                            <figure class="image"><img src="frontend/assets/images/shop/shop-19.png" alt=""></figure>
                                        </div>
                                        <div class="content-box">
                                            <h6><a href="shop-details.html">Super Bright Halogen Bulbs</a></h6>
                                            <ul class="rating"> 
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all cat-2 cat-4 cat-6 cat-7 cat-3">
                                <div class="shop-block-two">
                                    <div class="inner-box">
                                        <div class="image-box">
                                            <ul class="option-list">
                                                <li><a href="frontend/assets/images/shop/shop-20.png" class="lightbox-image" data-fancybox="gallery"><i class="icon-12"></i></a></li>
                                                <li><a href="shop-details.html"><i class="icon-1"></i></a></li>
                                                <li><button type="button"><i class="icon-7"></i></button></li>
                                            </ul>
                                            <figure class="image"><img src="frontend/assets/images/shop/shop-20.png" alt=""></figure>
                                        </div>
                                        <div class="content-box">
                                            <h6><a href="shop-details.html">Super Bright Halogen Bulbs</a></h6>
                                            <ul class="rating"> 
                                ...
                                <div class="shop-block-two">
                                    <div class="inner-box">
                                        <div class="image-box">
                                            <span class="discount-product">New</span>
                                            <ul class="option-list">
                                                <li><a href="frontend/assets/images/shop/shop-21.png" class="lightbox-image" data-fancybox="gallery"><i class="icon-12"></i></a></li>
                                                <li><a href="shop-details.html"><i class="icon-1"></i></a></li>
                                                <li><button type="button"><i class="icon-7"></i></button></li>
                                            </ul>
                                            <figure class="image"><img src="frontend/assets/images/shop/shop-21.png" alt=""></figure>
                                        </div>
                                        <div class="content-box">
                                            <h6><a href="shop-details.html">Super Bright Halogen Bulbs</a></h6>
                                            <ul class="rating"> 
                                ...
                                <div class="shop-block-two">
                                    <div class="inner-box">
                                        <div class="image-box">
                                            <span class="popular-product">Popular</span>
                                            <ul class="option-list">
                                                <li><a href="frontend/assets/images/shop/shop-22.png" class="lightbox-image" data-fancybox="gallery"><i class="icon-12"></i></a></li>
                                                <li><a href="shop-details.html"><i class="icon-1"></i></a></li>
                                                <li><button type="button"><i class="icon-7"></i></button></li>
                                            </ul>
                                            <figure class="image"><img src="frontend/assets/images/shop/shop-22.png" alt=""></figure>
                                        </div>
                                        <div class="content-box">
                                            <h6><a href="shop-details.html">Super Bright Halogen Bulbs</a></h6>
                                            <ul class="rating"> 
        ...
        <section class="flash-sales-section pt_90 pb_70">
            <div class="auto-container">
                <div class="sec-title mb_30">
                    <h2>Flash Sales</h2>
                    <a href="index-2.html">View All Products</a>
                </div>
                <div class="row clearfix">
                        ...
                        <div class="sales-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <figure class="image"><img src="frontend/assets/images/resource/sales-1.png" alt=""></figure>
                                </div>
                                <div class="content-box">
                                    <h6><a href="shop-details.html">Steel 22 inch Car Wheel Rim</a></h6>
                                    <h5>$483.99</h5>
                                    <ul class="rating"> 
                                        <li><i class="icon-41"></i></li>
                                        <li><i class="icon-41"></i></li>
                        ...
                        <div class="sales-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <figure class="image"><img src="frontend/assets/images/resource/sales-2.png" alt=""></figure>
                                </div>
                                <div class="content-box">
                                    <h6><a href="shop-details.html">Mercedes Engine oil Filter</a></h6>
                                    <h5>$283.99</h5>
                                    <ul class="rating"> 
                                        <li><i class="icon-41"></i></li>
                                        <li><i class="icon-41"></i></li>
                        ...
                        <div class="sales-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <figure class="image"><img src="frontend/assets/images/resource/sales-3.png" alt=""></figure>
                                </div>
                                <div class="content-box">
                                    <h6><a href="shop-details.html">Extra Key for Bugatti Chiron</a></h6>
                                    <h5>$53.99</h5>
                                    <ul class="rating"> 
                                        <li><i class="icon-41"></i></li>
                                        <li><i class="icon-41"></i></li>
                        ...
                        <div class="sales-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <figure class="image"><img src="frontend/assets/images/resource/sales-4.png" alt=""></figure>
                                </div>
                                <div class="content-box">
                                    <h6><a href="shop-details.html">Black 24 inch Car Wheel Rim</a></h6>
                                    <h5>$353.99</h5>
                                    <ul class="rating"> 
                                        <li><i class="icon-41"></i></li>
                                        <li><i class="icon-41"></i></li>
                        ...
                        <div class="sales-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <figure class="image"><img src="frontend/assets/images/resource/sales-5.png" alt=""></figure>
                                </div>
                                <div class="content-box">
                                    <h6><a href="shop-details.html">Quick start Battery Pack 12V</a></h6>
                                    <h5>$173.99</h5>
                                    <ul class="rating"> 
                                        <li><i class="icon-41"></i></li>
                                        <li><i class="icon-41"></i></li>
                        ...
                        <div class="sales-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <figure class="image"><img src="frontend/assets/images/resource/sales-6.png" alt=""></figure>
                                </div>
                                <div class="content-box">
                                    <h6><a href="shop-details.html">Classic 20W-40W Engine oil</a></h6>
                                    <h5>$121.99</h5>
                                    <ul class="rating"> 
                                        <li><i class="icon-41"></i></li>
                                        <li><i class="icon-41"></i></li>
        ...
        <section class="cta-section pb_100">
            <div class="auto-container">
                <div class="inner-container">
                    <div class="bg-layer" style="background-image: url(frontend/assets/images/background/cta-bg.jpg);"></div>
                    <div class="content-box">
                        ...
                        <a href="index-2.html">Get in Touch<i class="icon-27"></i></a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="auto-container">
                ...
                <div class="inner-container">
                    <div class="ads-box">
                        ...
                        <h3><a href="shop-details.html">Buy the Grills</a></h3>
                        <a href="shop.html" class="theme-btn">View All <span></span><span></span><span></span><span></span></a>
                        <figure class="image"><img src="frontend/assets/images/shop/shop-25.png" alt=""></figure>
                    </div>
                    <div class="content-box">
                        <div class="shop-carousel owl-carousel owl-theme owl-dots-none nav-style-one">
                            ...
                            <div class="shop-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <span class="hot-product">Hot</span>
                                        <ul class="option-list">
                                            <li><a href="frontend/assets/images/shop/shop-3.png" class="lightbox-image" data-fancybox="gallery"><i class="icon-12"></i></a></li>
                                            <li><a href="shop-details.html"><i class="icon-1"></i></a></li>
                                            <li><button type="button"><i class="icon-7"></i></button></li>
                                        </ul>
                                        <figure class="image"><img src="frontend/assets/images/shop/shop-3.png" alt=""></figure>
                                    </div>
                                    <div class="lower-content">
                                        <span class="text">Front</span>
                                        <h4><a href="shop-details.html">Toyota Starlet EP-82 HEAD Lights</a></h4>
                            ...
                            <div class="shop-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <ul class="option-list">
                                            <li><a href="frontend/assets/images/shop/shop-4.png" class="lightbox-image" data-fancybox="gallery"><i class="icon-12"></i></a></li>
                                            <li><a href="shop-details.html"><i class="icon-1"></i></a></li>
                                            <li><button type="button"><i class="icon-7"></i></button></li>
                                        </ul>
                                        <figure class="image"><img src="frontend/assets/images/shop/shop-4.png" alt=""></figure>
                                    </div>
                                    <div class="lower-content">
