...
<body>
    ...
    <p>
        Part of your order <strong>#{{ $order->order_number }}</strong> has been confirmed.
    </p>
    ...
    <p>
        We have started processing the item(s) above and will notify you once they are shipped.
    </p>
