...
<!--<div class="container mt-4">
    <h4>🛠 Role & Permissions Debug Info</h4>

    <div class="card p-3 mb-3">
        <p><strong>Superadmin Session:</strong> {{ session('superadmin') ? 'Yes' : 'No' }}</p>
        <p><strong>Role Code:</strong> {{ request()->attributes->get('role_code') ?? 'N/A' }}</p>
        <p><strong>Role ID:</strong> {{ request()->attributes->get('role_id') ?? 'N/A' }}</p>
        <p><strong>All Permissions:</strong> {{ request()->attributes->get('all_permissions') ? 'Yes' : 'No' }}</p>
        ...
        <ul>
            @php
                ...
                if (request()->attributes->get('all_permissions')) {
