                            ...
                            @foreach ($order->items as $index => $item)
                                <tr class="{{ $item->is_editable ? '' : 'row-not-editable' }}">
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="vendor-badge bg-light text-muted">{{ $item->vendor->shop_name ?? 'Vendor #' . $item->vendor_id }}</span>
                                        @endif
                                    </td>
                                    <td>
                                        @php
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="mb-1"><strong>Order Total:</strong> Rs. {{ number_format($order->total, 2) }}</p>
...
{{-- ===================== --}}
{{-- Per-item update modals (editable items only) --}}
{{-- ===================== --}}
@php
    $statuses = [
