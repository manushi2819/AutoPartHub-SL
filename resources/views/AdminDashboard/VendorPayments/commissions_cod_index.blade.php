                        ...
                        <tbody>
                            @foreach($pending as $settlement)
                                <tr>
                                    ...
                                    <td>{{ $settlement->vendor->address ?? '' }} - {{ $settlement->vendor->district ?? '' }}</td>
                                    ...
                                    <td>{{ $settlement->submitted_at->format('M d, Y H:i') }}</td>
                                    <td class="text-center">
                                        <a href="{{ route('admin.vendor-commissions-cod.show', $settlement->id) }}" class="btn btn-sm btn-primary">
                                            Review
                                        </a>
                                    </td>
                                </tr>
